...
function Why (){
    ...
    useEffect(() => {
        $.ajax({
            url: "https://api.securitepay.com.br/v1/benefits",
            method: 'GET',
            dataType: 'json', 
    ...
    const Card = ({ title, description, icon }) => (
        <div class="mb-3 snap-center sm:w-11/12 min-w-[288px] max-w-[400px]">
            <a disabled={true} target="_self" class="group flex flex-col select-none bg-gray-50 h-full rounded-3xl border-2 border-solid border-gray-200 p-6 hover:cursor-pointer hover:scale-105 hover:border-fuchsia-700">
